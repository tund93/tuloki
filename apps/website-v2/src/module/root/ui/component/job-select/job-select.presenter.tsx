...
import { Select, SelectContent, SelectGroup, SelectItem, SelectTrigger } from '@tuloki/core/component/select';
import { ArrowHeadIcon } from '@tuloki/core/icon/arrow-head-icon';
import { toKebabCase, toTitleCase } from '@tuloki/core/util/change-case';
